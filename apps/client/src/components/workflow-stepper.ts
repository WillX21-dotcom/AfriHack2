...
export function renderWorkflowStepper(workflows: RequestWorkflow[]): string {
        ...
        ${sorted
          .map((step) => {
            ...
            <div class="relative z-10 flex flex-col items-center">
              ...
              <span class="mt-2 text-[11px] font-medium text-slate-700 max-w-[70px] text-center leading-tight">
                ${step.step_name}
              </span>
            </div>
          `;
