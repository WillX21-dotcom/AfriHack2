...
-- section below). Use it to bootstrap a NEW project in the SQL editor. For the existing
-- linked project keep using `supabase db push` with the numbered migrations instead.
--
-- Contents
